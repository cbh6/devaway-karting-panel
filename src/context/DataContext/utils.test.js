...
describe('DataContext utils', () => {
  ...
  test('getGlobalRankingByPoints function', () => {
    ...
    expect(getGlobalRankingByPoints(rankingByRace)).toStrictEqual([
      { driverId: '5f3a3c5f8df3fe2e8c6ae477', rankingData: { podiums: 3, points: 91, wins: 0 } },
      { driverId: '5f3a3c5f37ce779261434517', rankingData: { podiums: 3, points: 78, wins: 0 } },
      { driverId: '5f3a3c5f0e202f4a527bf502', rankingData: { podiums: 3, points: 63, wins: 1 } },
      { driverId: '5f3a3c5fdc6f6738e4f35dd7', rankingData: { podiums: 2, points: 55, wins: 0 } },
      { driverId: '5f3a3c5f8a23c3e2c85cab74', rankingData: { podiums: 2, points: 51, wins: 1 } },
      { driverId: '5f3a3c5f0c713e786503e798', rankingData: { podiums: 3, points: 49, wins: 1 } },
      { driverId: '5f3a3c5fc4c1a2c2dd9df702', rankingData: { podiums: 3, points: 47, wins: 2 } },
      { driverId: '5f3a3c5f355a5be1fb74076a', rankingData: { podiums: 2, points: 47, wins: 1 } },
      { driverId: '5f3a3c5f086b43d06ac5a984', rankingData: { podiums: 3, points: 46, wins: 1 } },
      { driverId: '5f3a3c5f86cbcda872a8f1ed', rankingData: { podiums: 2, points: 39, wins: 1 } },
      { driverId: '5f3a3c5f4984bd9be6a6f655', rankingData: { podiums: 1, points: 38, wins: 1 } },
      { driverId: '5f3a3c5f0a5f78c603fc1d14', rankingData: { podiums: 1, points: 37, wins: 1 } },
      { driverId: '5f3a3c5faa55d5c4ea549ac1', rankingData: { podiums: 0, points: 36, wins: 0 } },
      { driverId: '5f3a3c5f8bd0087dc1b70b77', rankingData: { podiums: 1, points: 34, wins: 0 } },
      ...
      { driverId: '5f3a3c5f65e328c1a1263781', rankingData: { podiums: 1, points: 29, wins: 0 } },
